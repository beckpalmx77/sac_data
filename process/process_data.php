...
";
    ...
    if ($nRows > 0) {
        ...
        $query_update->bindParam(':TRD_QTY', $result['TRD_QTY'], PDO::PARAM_STR);
        $query_update->bindParam(':TRD_G_KEYIN', $result['TRD_G_KEYIN'], PDO::PARAM_STR);
        ...
        $query_inset->bindParam(':TRD_QTY', $result['TRD_QTY'], PDO::PARAM_STR);
        $query_inset->bindParam(':TRD_G_KEYIN', $result['TRD_G_KEYIN'], PDO::PARAM_STR);
