...
for ($loop = 1; $loop <= 2; $loop++) {
    ...
    if ($loop === 1) {
        ...
        $data = "DI_REF,DI_DATE,AR_CODE,AR_NAME,SLMN_CODE,SLMN_NAME,SKU_CODE,SKU_NAME,BRN_NAME,BRN_CODE,TRD_QTY,TRD_Q_FREE,TRD_U_PRC,TRD_G_KEYIN,TRD_G_SELL,TRD_G_VAT,WL_CODE,ARCD_NAME\n";
