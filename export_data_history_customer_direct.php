...
if (strlen($_SESSION['alogin']) == "") {
                                                ...
                                                <div class="panel">
                                                    <div class="panel-body">
                                                        ...
                                                        <form id="from_data" method="post"
                                                              action="export_process/export_process_data_history_customer_direct.php"
    ...
    <script>
        $(document).ready(function () {
            ...
            // คำนวณปีปัจจุบัน ลบออก 10 ปี
            let lastTenYears = today.getFullYear() - 10;

            // กำหนดวันที่เริ่มต้นเป็น 01-01-ปีที่คำนวณได้
            let startDate = "01-01-" + lastTenYears;

            // วันที่ปัจจุบันสำหรับ "ถึงวันที่"
            let endDate = getDay2Digits(today) + "-" + getMonth2Digits(today) + "-" + today.getFullYear();

            $('#doc_date_start').val(startDate);
            $('#doc_date_to').val(endDate);
        });
    </script>
