...
FROM
    DOCINFO WITH (NOLOCK),
    DOCTYPE WITH (NOLOCK),
    TRANSTKH WITH (NOLOCK),
    TRANSTKD WITH (NOLOCK),
    ARDETAIL WITH (NOLOCK),
    EXCHANGERATE WITH (NOLOCK),
    ARFILE WITH (NOLOCK),
    GOODSMASTER WITH (NOLOCK),
    ...
    DEPTTAB WITH (NOLOCK),
    BRANCH WITH (NOLOCK),
    WARELOCATION WITH (NOLOCK),
    WAREHOUSE WITH (NOLOCK),
    SLDETAIL WITH (NOLOCK),
    SALESMAN WITH (NOLOCK),
    MKTPLAN WITH (NOLOCK),
    PRMTPLAN WITH (NOLOCK),
    VATTABLE WITH (NOLOCK)";
