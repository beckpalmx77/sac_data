...
"SELECT
DOCINFO.DI_REF,
FORMAT(DOCINFO.DI_DATE,'dd/MM/yyyy')asDI_DATE,
DOCINFO.DI_ACTIVE,
ARFILE.AR_CODE,
ARFILE.AR_NAME,
ARDETAIL.ARD_B_AMTAROE_B_AMT,
ARDETAIL.ARD_B_VAT,
ARDETAIL.ARD_B_SV,
ARDETAIL.ARD_B_SNV,
...
TRANSTKH.TRH_MKTP=MKTPLAN.MKTP_KEYAND
TRANSTKH.TRH_PRMT=PRMTPLAN.PRMT_KEYAND
(DOCINFO.DI_ACTIVE=0)AND
(DOCINFO.DI_KEY=SLDETAIL.SLD_DI)AND
(SLDETAIL.SLD_SLMN=SALESMAN.SLMN_KEY)ANDSKUMASTER.SKU_S_UTQ=UOFQTY.UTQ_KEY"	;
