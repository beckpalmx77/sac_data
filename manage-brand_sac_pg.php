                                                        ...
                                                        <div class="modal-body">
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="form-group">
                                                                    <label for="id" class="control-label">รหัสยี่ห้อ-ชื่อทางการค้า</label>
                                                                ...
                                                                <div class="form-group">
                                                                    <label for="enable"
                                                                           class="control-label">enable</label>
    ...
    <script>
        ...
        $("#name").blur(function () {
            ...
            if (method === "ADD") {
                let id = $('#id').val();
                let name = $('#name').val();
                let formData = {action: "SEARCH", id: id, name: name};
                $.ajax({
    ...
    <script>
        $(document).ready(function () {
            ...
            let dataRecords = $('#TableRecordList').DataTable({
                ...
                'serverMethod': 'post',
                'ajax': {
                    'url': 'model/manage_brand_pg_process.php',
                    'data': formData
                },
                'columns': [
                    {data: 'id'},
