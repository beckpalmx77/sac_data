...
include(dirname(__DIR__) . "/config/connect_db2.php");
...
try {
    ...
    echo "customer_ar_2 import finished. Insert: $count_insert, Update: $count_update (Time: {$elapsed} s)\n";
} catch (Exception $e) {
    $conn->rollBack();
    echo "Error in customer_ar_2 import: " . $e->getMessage() . "\n";
}
